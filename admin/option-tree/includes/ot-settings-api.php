...
echo ' ';
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
                ...
                /* Sub Header */
                echo '<div id="option-tree-sub-header"><h1>تنظیمات سایت</h1>';
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) . '">';
                  ...
                  echo '<button type="submit" class="option-tree-ui-button button button-secondary left reset-settings" title="' . __( 'بازیابی تنظیمات', 'option-tree' ) . '">' . __( 'بازیابی تنظیمات', 'option-tree' ) . '</button>';
      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          foreach( (array) $this->get_sections( $page ) as $section ) {
            ...
            /* add each section - reza kianoosh - rkianoosh.ir - ronakweb.com */
      ...
      foreach ( (array) $wp_settings_sections[$page] as $section ) {
        ...
        echo '<div id="section_' . $section_id . '" class="postbox ui-tabs-panel">';
          ...
          echo '<div class="inside">';
             ...
             * reza kianoosh - rkianoosh.ir - ronakweb.com
             * @since 2.6.0
             *
             * @param string $page       The page slug.
             * @param string $section_id The section ID.
