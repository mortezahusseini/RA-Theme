  ...
  function ot_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'افزودن', 'option-tree' ) . '">' . __( 'افزودن', 'option-tree' ) . '</a>';
        
        /* description */
        $list_desc = $sortable ? __( 'شما می‌توانید با کشیدن و رها کردن، آیتم‌ها را جابجا کنید.', 'option-tree' ) : '';
  ...
  function ot_type_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* description */
        echo '<div class="list-item-description">' . __( 'شما می‌توانید با کشیدن و رها کردن، آیتم‌ها را جابجا کنید.', 'option-tree' ) . '</div>';
  ...
  function ot_type_social_links( $args = array() ) {
    ...
    echo '<div class="format-setting type-social-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'افزودن', 'option-tree' ) . '">' . __( 'افزودن', 'option-tree' ) . '</a>';
        
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'ot_social_links_description', __( 'شما می‌توانید با کشیدن و رها کردن، آیتم‌ها را جابجا کنید.', 'option-tree' ), $field_id ) . '</div>';
