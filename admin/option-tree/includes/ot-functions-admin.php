          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'تنظیمات سایت', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'تنظیمات سایت', 'option-tree' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'تنظیمات سایت بروزرسانی شد.', 'option-tree' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'تنظیمات سایت بروزرسانی شد.', 'option-tree' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'ذخیره‌ی تغییرات', 'option-tree' ) ),
  ...
  function ot_register_settings_page() {
    ...
    $ot_register_pages_array =  array( 
      ...
      array(
        ...
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'تنظیمات پوسته بروزرسانی شد.', 'option-tree' ),
        'reset_message'   => __( 'تنظیمات پوسته بازیابی شد.', 'option-tree' ),
        'button_text'     => __( 'ذخیره‌ی تغییرات', 'option-tree' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
      ...
      array(
        ...
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'تنظیمات سایت بروزرسانی شد.', 'option-tree' ),
        'reset_message'   => __( 'تنظیمات سایت بازیابی شد.', 'option-tree' ),
        'button_text'     => __( 'ذخیره‌ی تغییرات', 'option-tree' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'reset_agree'           => __( 'آیا شما از بازیابی تنظیمات به حالت پیش‌فرض اطمینان دارید؟', 'option-tree' ),
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'ویرایش', 'option-tree' ) . '">
          <span class="icon ot-icon-pencil"></span>' . __( 'Edit', 'option-tree' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'پاک کردن', 'option-tree' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'پاک کردن', 'option-tree' ) . '
        </a>
      </div>
...
if ( ! function_exists( 'ot_settings_view' ) ) {
  ...
  function ot_settings_view( $name, $key, $setting = array() ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . __( 'ویرایش', 'option-tree' ) . '">
          <span class="icon ot-icon-pencil"></span>' . __( 'ویرایش', 'option-tree' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'پاک کردن', 'option-tree' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'پاک کردن', 'option-tree' ) . '
        </a>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . __( '<strong>عنوان</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
